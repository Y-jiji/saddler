...
Propose is required for every command known to be longer than 5 seconds (you don't know until you test), and for every `Write/Edit` on a file. Otherwise, just act. 
